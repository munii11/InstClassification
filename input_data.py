...
class AudioProcessor(object):
  ...
  def __init__(self, dest_dir, silence_percentage, unknown_percentage,
               wanted_words, validation_percentage, testing_percentage,
               model_settings, summaries_dir):
    if dest_dir:
      self.data_dir = dest_dir
      self.maybe_download_and_extract_dataset(dest_dir)
  ...
  def maybe_download_and_extract_dataset(self, dest_directory):
  ...
  def get_data(self, how_many, offset, model_settings, background_frequency,
    ...
    for i in xrange(offset, offset + sample_count):
      ...
      if use_background == SILENCE_LABEL:

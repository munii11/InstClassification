...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='cel,cla,flu,gac,gel,org,pia,sax,tru,vio,voi',
      help='Words to use (others will be added to an unknown label)',)
  parser.add_argument(
      '--output_file', type=str, default='./tmp/freeze_graph.pb', help='Where to save the frozen graph.')
  parser.add_argument(
      '--quantize',
      type=bool,
      default=False,
